...
export class InitialPrimePlateSchema1786340767479 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "daily_menus" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "items" json NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "mealPlanId" uuid, CONSTRAINT "PK_934c4161c03d4a05822109359a0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "refresh_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tokenHash" character varying NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "revoked" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_7d8bee0204106019488c4c50ffa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" integer NOT NULL, "comment" text NOT NULL, "providerReply" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "studentId" uuid, "providerId" uuid, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_0d65ce2454954e71c67ea424c4" ON "payments"  ("razorpayOrderId") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_487700240ef0deb9acf13f5a37" ON "payments"  ("razorpayPaymentId") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_status_enum" AS ENUM('active', 'paused', 'cancelled', 'expired')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "daily_menus" ADD CONSTRAINT "FK_dc6a6ba61ed224fc7243df10aae" FOREIGN KEY ("mealPlanId") REFERENCES "meal_plans"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" ADD CONSTRAINT "FK_d3ea9d2e4fc290371c1e98edef2" FOREIGN KEY ("providerId") REFERENCES "meal_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_providers" ADD CONSTRAINT "FK_c953deda3cc9005088466c0e7c9" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reviews" ADD CONSTRAINT "FK_4c29faa8169d9741d3a1d514830" FOREIGN KEY ("providerId") REFERENCES "meal_providers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_a25d33dbd8e95a1875d42ac40c3" FOREIGN KEY ("providerId") REFERENCES "meal_providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_f62e9a735f10ce6006ac230fcf9" FOREIGN KEY ("studentId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_aa2ca1e4560c2c75dde4928016c" FOREIGN KEY ("mealPlanId") REFERENCES "meal_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "weekly_menus" ADD CONSTRAINT "FK_322fb2b168518ef13a7412a9947" FOREIGN KEY ("providerId") REFERENCES "meal_providers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "weekly_menus" DROP CONSTRAINT "FK_322fb2b168518ef13a7412a9947"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_aa2ca1e4560c2c75dde4928016c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "meal_providers" DROP CONSTRAINT "FK_c953deda3cc9005088466c0e7c9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "meal_plans" DROP CONSTRAINT "FK_d3ea9d2e4fc290371c1e98edef2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "daily_menus" DROP CONSTRAINT "FK_dc6a6ba61ed224fc7243df10aae"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."meal_providers_approvalstatus_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."meal_providers_category_enum"`,
    );
